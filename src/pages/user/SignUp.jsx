...
const SignUp = ({ onNavigateToLogin, onNavigateToRegistration }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const isValid = !newErrors.idNumber && !newErrors.password;
    
    if (isValid) {
      // UI only - no actual signup logic
  ...
  const handleGoogleSignup = () => {
    // UI only - no actual Google signup logic
  ...
  return (
    <div className="signup-container">
      ...
      <div className="signup-form-container">
        ...
        <p className="signup-subtitle">Fill your information below or register with your google account</p>
        ...
        <form onSubmit={handleSubmit} className="signup-form">
          <div className="form-group">
            ...
            <input
              ...
              onBlur={handleBlur}
              className={`form-input ${touched.idNumber && errors.idNumber ? 'error' : ''}`}
          ...
          <div className="form-group">
            ...
            <div className="password-input-container">
              <input
                ...
                onChange={handleInputChange}
                onBlur={handleBlur}
                className={`form-input password-input ${touched.password && errors.password ? 'error' : ''}`}
